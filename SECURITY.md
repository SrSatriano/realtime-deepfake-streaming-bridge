...
1. Envie descrição detalhada para o mantenedor via GitHub Security Advisories ou contato privado do repositório [realtime-deepfake-streaming-bridge](https://github.com/SrSatriano/realtime-deepfake-streaming-bridge).
