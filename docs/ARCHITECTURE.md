# Arquitetura — Ponte de streaming deepfake em tempo real

> Versão do documento: **1.0.0** · Última revisão: **2026-03-26**

## 1. Visão geral

Pipeline CUDA FP16 com saída para OBS/câmera virtual.
...
| Inferência | Inferência FP16 |
| Câmera | Câmera virtual |
| Guia | Guia de VRAM |
| Integração | Integração OBS |
